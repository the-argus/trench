...
public class pop_up_black : MonoBehaviour
{
	[SerializeField] float delay = (float)0.05;
	[SerializeField] float page_delay = (float)5.0;
	...
	void OnTriggerEnter(Collider Player)
	{
		...
		string[] lines = new string[] { "Oh, hello! Do you happen to know where everyone’s going?", "What’s that? Medicine?" };
